    ...
    var body: some View {
        VStack {
           ...
           // RequirementText(text: "A minimum of 4 characters")
            ...
            .secondary : Color(red: 251/255, green: 128/255, blue: 128/255), text: "A minimum of 4 characters", isStrikeThrough: userRegistrationViewModel.isUsernameLengthValid
            )
            .padding()
